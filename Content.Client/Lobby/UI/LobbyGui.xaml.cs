...
using Content.Client._Mini.AntagTokens;
...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class LobbyGui : UIScreen
    {
        ...
        public LobbyGui()
        {
            ...
            DailyRewardsButton.OnPressed += _ => _entityManager.System<DailyRewardUiSystem>().RequestOpen();
            AntagTokenButton.OnPressed += _ => _entityManager.System<AntagTokenUiSystem>().RequestOpen();
        }
