...
public sealed class AntagTokenWindow : DefaultWindow
{
    ...
    private static readonly Color PurchasedCardColor = Color.FromHex("#55104d");
    private static readonly Color PurchasedBorderColor = Color.FromHex("#ff5abb");
    private static readonly Color BuyButtonUnavailableBg = Color.FromHex("#1b0b25");
    private static readonly Color BuyButtonTimerText = Color.FromHex("#ff9bd1");
    ...
    private Control BuildHero()
    {
        ...
        // In queue, without the ticket icon.
    ...
    private Control CreateRoleCard(AntagTokenRoleEntry entry)
    {
        ...
        if (entry.StatusLocKey != null)
        {
            root.AddChild(new Label
            {
                ...
                Modulate = entry.Purchased ? PurchasedBorderColor : Color.FromHex("#ffd6ef"),
                HorizontalAlignment = HAlignment.Center,
                MaxWidth = 268
            });
        }
