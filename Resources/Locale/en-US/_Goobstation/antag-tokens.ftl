...
antag-store-role-hastur-name = King in Yellow
antag-store-role-hastur-description = A King in Yellow ghost role.
antag-store-role-vox-name = Vox raider
antag-store-role-vox-description = A Vox raider ghost role.
